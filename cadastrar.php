    ...
    <section class="content">
        <div class="contato">
            ...
            <form class="form" method="POST">
                ...
                <input class="field button"type="submit" value="Cadastrar">
                <button class="field button"><a href="listar.php" style="text-decoration: none; color:black">Listar Cadastros</a></button>
            </form>
        </div>
    </section>
</body>
...
if($_POST){
    ...
    */
    ...
    if($executa){
        echo "<h4 style= 'display: flex; justify-content: center;'>
        Cadastrado com sucesso!</h4>";
    }else{
